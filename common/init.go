...
func printHelp() {
	fmt.Println("CnaiRouter(Based OneAPI) " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Maintainer: QuantumNous - https://github.com/QuantumNous/cnairouter")
	fmt.Println("Usage: cnairouter [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
